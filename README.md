...
| **사용 기술 스택** | **FE: React** / **BE: Spring Boot, Spring Security** / **DB: PostgreSQL (w/ PostGIS)** / **통신: WebSocket, Web Push** |
...
| **검색 & 필터** | 복합 검색 | 키워드, 기술 스택 태그, 모집 상태 등 **다중 조건**을 조합하여 검색. | |
| | 위치 기반 검색 | 현재 위치를 기준으로 **반경 X km 이내**의 스터디 목록을 조회. | **PostGIS** |
...
* **해결:**
    ...
    3.  Spring Boot 백엔드에서 PostGIS 함수를 호출하여 **효율적인 거리 기반 쿼리**를 실행합니다.
...
https://holaworld.io/ -> 스터디매칭 웹 서비스 ( 서울 위주라 찾기 힘들었음 )